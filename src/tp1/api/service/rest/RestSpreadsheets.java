...
public interface RestSpreadsheets {
	...
	/**
	 * Retrieves the calculated values of a spreadsheet in a specified range.
	 * @param userId - The user requesting the values
	 * @param range - the range to get in the spreadsheet
	 * @param sheetId - the spreadsheet whose values are being retrieved.
	 *
	 * @return 200, if the operation is successful
	 * 		   403, if the spreadsheet is not shared with user, or the user is not the owner.
	 * 		   404, if the spreadsheet does not exist
	 *		   400, otherwise
	 */
	@GET
	@Path("/{sheetId}/range")
